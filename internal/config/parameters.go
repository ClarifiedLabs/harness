...
var definitions = []parameterDefinition{
	...
	intDef("run_command_timeout_seconds", "run_command_timeout_seconds", nil, []string{"HARNESS_RUN_COMMAND_TIMEOUT_SECONDS"}, literal(0, "", "tool default"), func(f fileConfig) optional[int] { return f.RunCommandTimeoutSeconds }, func(c *Config, v int) { c.RunCommandTimeoutSeconds = v }, func(c Config) int { return c.RunCommandTimeoutSeconds }, nonNegative("run_command_timeout_seconds")),
	intDef("run_command_background_timeout_seconds", "run_command_background_timeout_seconds", nil, []string{"HARNESS_RUN_COMMAND_BACKGROUND_TIMEOUT_SECONDS"}, literal(0, "", "tool default"), func(f fileConfig) optional[int] { return f.RunCommandBackgroundTimeoutSeconds }, func(c *Config, v int) { c.RunCommandBackgroundTimeoutSeconds = v }, func(c Config) int { return c.RunCommandBackgroundTimeoutSeconds }, nonNegative("run_command_background_timeout_seconds")),
	...
	intDef("rg_result_max_bytes", "rg_result_max_bytes", nil, []string{"HARNESS_RG_RESULT_MAX_BYTES"}, literal(0, "", "tool default"), func(f fileConfig) optional[int] { return f.RGResultMaxBytes }, func(c *Config, v int) { c.RGResultMaxBytes = v }, func(c Config) int { return c.RGResultMaxBytes }, nonNegative("rg_result_max_bytes")),
	intDef("rg_result_max_lines", "rg_result_max_lines", nil, []string{"HARNESS_RG_RESULT_MAX_LINES"}, literal(0, "", "tool default"), func(f fileConfig) optional[int] { return f.RGResultMaxLines }, func(c *Config, v int) { c.RGResultMaxLines = v }, func(c Config) int { return c.RGResultMaxLines }, nonNegative("rg_result_max_lines")),
	intDef("grep_result_max_bytes", "grep_result_max_bytes", nil, []string{"HARNESS_GREP_RESULT_MAX_BYTES"}, literal(0, "", "tool default"), func(f fileConfig) optional[int] { return f.GrepResultMaxBytes }, func(c *Config, v int) { c.GrepResultMaxBytes = v }, func(c Config) int { return c.GrepResultMaxBytes }, nonNegative("grep_result_max_bytes")),
	intDef("grep_result_max_lines", "grep_result_max_lines", nil, []string{"HARNESS_GREP_RESULT_MAX_LINES"}, literal(0, "", "tool default"), func(f fileConfig) optional[int] { return f.GrepResultMaxLines }, func(c *Config, v int) { c.GrepResultMaxLines = v }, func(c Config) int { return c.GrepResultMaxLines }, nonNegative("grep_result_max_lines")),
	intDef("read_file_default_limit", "read_file_default_limit", nil, []string{"HARNESS_READ_FILE_DEFAULT_LIMIT"}, literal(0, "", "tool default"), func(f fileConfig) optional[int] { return f.ReadFileDefaultLimit }, func(c *Config, v int) { c.ReadFileDefaultLimit = v }, func(c Config) int { return c.ReadFileDefaultLimit }, nonNegative("read_file_default_limit")),
	intDef("read_file_result_max_bytes", "read_file_result_max_bytes", nil, []string{"HARNESS_READ_FILE_RESULT_MAX_BYTES"}, literal(0, "", "tool default"), func(f fileConfig) optional[int] { return f.ReadFileResultMaxBytes }, func(c *Config, v int) { c.ReadFileResultMaxBytes = v }, func(c Config) int { return c.ReadFileResultMaxBytes }, nonNegative("read_file_result_max_bytes")),
	intDef("read_file_result_max_lines", "read_file_result_max_lines", nil, []string{"HARNESS_READ_FILE_RESULT_MAX_LINES"}, literal(0, "", "tool default"), func(f fileConfig) optional[int] { return f.ReadFileResultMaxLines }, func(c *Config, v int) { c.ReadFileResultMaxLines = v }, func(c Config) int { return c.ReadFileResultMaxLines }, nonNegative("read_file_result_max_lines")),
	...
	intDef("delegate_max_descendants", "delegate_max_descendants", nil, nil, literal(defaultDelegateMaxDescendants, "", ""), func(f fileConfig) optional[int] { return f.DelegateMaxDescendants }, func(c *Config, v int) { c.DelegateMaxDescendants = v }, func(c Config) int { return c.DelegateMaxDescendants }, positive("delegate_max_descendants")),
	intDef("delegate_max_per_step", "delegate_max_per_step", nil, nil, literal(defaultDelegateMaxPerStep, "", ""), func(f fileConfig) optional[int] { return f.DelegateMaxPerStep }, func(c *Config, v int) { c.DelegateMaxPerStep = v }, func(c Config) int { return c.DelegateMaxPerStep }, positive("delegate_max_per_step")),
	...
	strDef("handoff_agent", "handoff_agent", []string{"handoff-agent"}, []string{"HARNESS_HANDOFF_AGENT"}, literal("auto", "", ""), func(f fileConfig) optional[string] { return f.HandoffAgent }, func(c *Config, v string) { c.HandoffAgent = v }, func(c Config) string { return c.HandoffAgent }, func(v string) (string, error) { return canonicalLowerNonEmpty("handoff_agent", v) }, nil, false),
