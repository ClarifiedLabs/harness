...
var definitions = []parameterDefinition{
	...
	strDef("context_management", "context_management", nil, nil, literal("auto", "", ""), func(f fileConfig) optional[string] { return f.ContextManagement }, func(c *Config, v string) { c.ContextManagement = v }, func(c Config) string { return c.ContextManagement }, func(v string) (string, error) {
		return canonicalChoice("context_management", v, "auto", "on", "off")
	}, []string{"auto", "on", "off"}, false),
	boolDef("codex_experimental_context_management", "codex_experimental_context_management", nil, nil, literal(true, "", ""), func(f fileConfig) optional[bool] { return f.CodexExperimentalContextManagement }, func(c *Config, v bool) { c.CodexExperimentalContextManagement = v }, func(c Config) bool { return c.CodexExperimentalContextManagement }),
	boolDef("experimental_async_tools", "experimental_async_tools", nil, nil, literal(false, "", ""), func(f fileConfig) optional[bool] { return f.ExperimentalAsyncTools }, func(c *Config, v bool) { c.ExperimentalAsyncTools = v }, func(c Config) bool { return c.ExperimentalAsyncTools }),
	boolDef("astra_native_steering", "astra_native_steering", nil, nil, literal(true, "", ""), func(f fileConfig) optional[bool] { return f.AstraNativeSteering }, func(c *Config, v bool) { c.AstraNativeSteering = v }, func(c Config) bool { return c.AstraNativeSteering }),
	...
	intDef("compact_input_tokens", "compact_input_tokens", nil, nil, literal(0, "", "disabled"), func(f fileConfig) optional[int] { return f.CompactInputTokens }, func(c *Config, v int) { c.CompactInputTokens = v }, func(c Config) int { return c.CompactInputTokens }, nonNegative("compact_input_tokens")),
	intDef("compact_growth_tokens", "compact_growth_tokens", nil, nil, literal(0, "", "disabled"), func(f fileConfig) optional[int] { return f.CompactGrowthTokens }, func(c *Config, v int) { c.CompactGrowthTokens = v }, func(c Config) int { return c.CompactGrowthTokens }, nonNegative("compact_growth_tokens")),
