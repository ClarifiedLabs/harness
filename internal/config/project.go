...
func mergeFileConfig(global, project fileConfig, globalPath, projectPath string) (fileConfig, map[string]string) {
	...
	out.ShellTimeoutSeconds = mergeOpt(global.ShellTimeoutSeconds, project.ShellTimeoutSeconds, globalPath, projectPath, "shell_timeout_seconds", sourceMap)
	out.ShellBackgroundTimeoutSeconds = mergeOpt(global.ShellBackgroundTimeoutSeconds, project.ShellBackgroundTimeoutSeconds, globalPath, projectPath, "shell_background_timeout_seconds", sourceMap)
	...
	out.ReadDefaultLimit = mergeOpt(global.ReadDefaultLimit, project.ReadDefaultLimit, globalPath, projectPath, "read_default_limit", sourceMap)
	out.ReadTotalLinesMaxBytes = mergeOpt(global.ReadTotalLinesMaxBytes, project.ReadTotalLinesMaxBytes, globalPath, projectPath, "read_total_lines_max_bytes", sourceMap)
	out.ReadResultMaxBytes = mergeOpt(global.ReadResultMaxBytes, project.ReadResultMaxBytes, globalPath, projectPath, "read_result_max_bytes", sourceMap)
	out.ReadResultMaxLines = mergeOpt(global.ReadResultMaxLines, project.ReadResultMaxLines, globalPath, projectPath, "read_result_max_lines", sourceMap)
	...
	out.ContextManagement = mergeOpt(global.ContextManagement, project.ContextManagement, globalPath, projectPath, "context_management", sourceMap)
	out.CodexExperimentalContextManagement = mergeOpt(global.CodexExperimentalContextManagement, project.CodexExperimentalContextManagement, globalPath, projectPath, "codex_experimental_context_management", sourceMap)
	out.ExperimentalAsyncTools = mergeOpt(global.ExperimentalAsyncTools, project.ExperimentalAsyncTools, globalPath, projectPath, "experimental_async_tools", sourceMap)
	out.AstraNativeSteering = mergeOpt(global.AstraNativeSteering, project.AstraNativeSteering, globalPath, projectPath, "astra_native_steering", sourceMap)
	out.CompactInputTokens = mergeOpt(global.CompactInputTokens, project.CompactInputTokens, globalPath, projectPath, "compact_input_tokens", sourceMap)
	out.CompactGrowthTokens = mergeOpt(global.CompactGrowthTokens, project.CompactGrowthTokens, globalPath, projectPath, "compact_growth_tokens", sourceMap)
	...
	out.RetentionKeepTurns = mergeOpt(global.RetentionKeepTurns, project.RetentionKeepTurns, globalPath, projectPath, "retention_keep_turns", sourceMap)
	out.RetentionResultHeadBytes = mergeOpt(global.RetentionResultHeadBytes, project.RetentionResultHeadBytes, globalPath, projectPath, "retention_result_head_bytes", sourceMap)
	...
	out.StagnationNudge = mergeOpt(global.StagnationNudge, project.StagnationNudge, globalPath, projectPath, "stagnation_nudge", sourceMap)
...
func mergeOTelOpt(global, project optional[fileOTelConfig], globalPath, projectPath string, sourceMap map[string]string) optional[fileOTelConfig] {
	...
	var merged fileOTelConfig
	merged.Enabled = mergeOpt(gVal.Enabled, pVal.Enabled, globalPath, projectPath, "otel.enabled", sourceMap)
	merged.Endpoint = mergeOpt(gVal.Endpoint, pVal.Endpoint, globalPath, projectPath, "otel.endpoint", sourceMap)
