...
- Turn progress renders as plain stderr lines, e.g. `[turn: 1 waiting]`. A
  ...
  `[turn: 1 · 6s · $0.032 · ctx 74% 148.0k/200.0k │ prompt 18s · $0.045]`, including the
  ...
  model has no configured price). The trailing figure after the prompt elapsed
  time is the running prompt total over completed turns so far. The enclosing prompt emits one
