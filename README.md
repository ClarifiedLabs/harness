...
- Apple silicon (arm64): [`.pkg` (v0.5.21)](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness_v0.5.21_darwin_arm64.pkg)

### Linux

The latest release, v0.5.21, is available for amd64/x86_64 and arm64/aarch64:

| Binary | amd64 / x86_64 | arm64 / aarch64 |
|---|---|---|
| `harness` | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness_0.5.21_amd64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness-0.5.21-1.x86_64.rpm) | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness_0.5.21_arm64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness-0.5.21-1.aarch64.rpm) |
| `harness-model-proxy` | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness-model-proxy_0.5.21_amd64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness-model-proxy-0.5.21-1.x86_64.rpm) | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness-model-proxy_0.5.21_arm64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness-model-proxy-0.5.21-1.aarch64.rpm) |
| `harness-mcp-proxy` | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness-mcp-proxy_0.5.21_amd64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness-mcp-proxy-0.5.21-1.x86_64.rpm) | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness-mcp-proxy_0.5.21_arm64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.5.21/harness-mcp-proxy-0.5.21-1.aarch64.rpm) |

### Docker

Multi-architecture images are available for Linux amd64 and arm64:

- [`ghcr.io/clarifiedlabs/harness:0.5.21`](https://github.com/ClarifiedLabs/harness/pkgs/container/harness)
- [`ghcr.io/clarifiedlabs/harness-model-proxy:0.5.21`](https://github.com/ClarifiedLabs/harness/pkgs/container/harness-model-proxy)
- [`ghcr.io/clarifiedlabs/harness-mcp-proxy:0.5.21`](https://github.com/ClarifiedLabs/harness/pkgs/container/harness-mcp-proxy)
