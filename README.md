...
- Apple silicon (arm64): [`.pkg` (v0.0.38)](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness_v0.0.38_darwin_arm64.pkg)

### Linux

The latest release, v0.0.38, is available for amd64/x86_64 and arm64/aarch64:

| Binary | amd64 / x86_64 | arm64 / aarch64 |
|---|---|---|
| `harness` | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness_0.0.38_amd64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness-0.0.38-1.x86_64.rpm) | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness_0.0.38_arm64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness-0.0.38-1.aarch64.rpm) |
| `harness-model-proxy` | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness-model-proxy_0.0.38_amd64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness-model-proxy-0.0.38-1.x86_64.rpm) | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness-model-proxy_0.0.38_arm64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness-model-proxy-0.0.38-1.aarch64.rpm) |
| `harness-mcp-proxy` | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness-mcp-proxy_0.0.38_amd64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness-mcp-proxy-0.0.38-1.x86_64.rpm) | [`.deb`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness-mcp-proxy_0.0.38_arm64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/harness/releases/download/v0.0.38/harness-mcp-proxy-0.0.38-1.aarch64.rpm) |

### Docker

Multi-architecture images are available for Linux amd64 and arm64:

- [`ghcr.io/clarifiedlabs/harness:0.0.38`](https://github.com/ClarifiedLabs/harness/pkgs/container/harness)
- [`ghcr.io/clarifiedlabs/harness-model-proxy:0.0.38`](https://github.com/ClarifiedLabs/harness/pkgs/container/harness-model-proxy)
- [`ghcr.io/clarifiedlabs/harness-mcp-proxy:0.0.38`](https://github.com/ClarifiedLabs/harness/pkgs/container/harness-mcp-proxy)
